...
# 
# 	curl -O https://raw.github.com/simonpioli/auto-wordpress/master/auto-wordpress.sh | bash
#
# 	There you go.
#
...
if [ $theme == "bones" ]; then
	echo "Fetching Bones...";
	curl -O https://github.com/eddiemachado/bones/archive/master.zip;
	...
	curl -O https://github.com/Automattic/_s/archive/master.zip;
